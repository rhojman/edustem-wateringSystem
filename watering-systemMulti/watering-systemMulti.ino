#include <Servo.h>
//Define el pin de control de la bomba de agua
const int pumpAnodePin =  6;      //pin 6 conectado al ánodo de la bomba de agua
const int pumpCathodePin =  7;   //pin 7 conectado al cátodo de la bomba de agua

Servo servoH;  // crea un objeto servo Horizontal
Servo servoV;  // crea un objeto servo Vertical
...
int umbralInf_3 = 50; // cota inferior de humedad en porcentaje sensor 3
...
void regar(int j){
  while(j < (sizeof(sensor_list)/sizeof(int))){   
    int i=j;
    humed1 = analogRead(sensor_list[i]);            // lee el valor del sensor de humedad 
